...
void naive_intersections(const std::vector<LineSeg>& seg) {
...
bool FindIntersections(std::vector<LineSeg> segments) {
	...
	// Sort vectors (will use the < operator in Event class)
...
int main(int argc, char* argv[])
{
	...
	// auto segments = readSegments("../../../../data/test3.dat");
